 ...
 */
var CLIENT_ID string = "10020"

/**
* in developer settings : Key
 */
var CLIENT_SYMMETRIC_KEY string = "PCd1dlEmFnBXaVce06Pzp7Vike0oHnVJ"

/**
* in developer settings : Secret
 */
var CLIENT_SECRET string = "F0NfID1ftdGdu27ybGMfT3vqqCMM9gwO"

/**
* in developer settings : Server Public Key
 */
var SERVER_PUB_KEY string = "-----BEGIN PUBLIC KEY-----\n" +
 ...
 */
func Init(verNo, apiUrl, appId, key, secret, serverPubKey, privateKey string) {
	VERSION_NO = verNo
	BASE_URL = apiUrl
	CLIENT_ID = appId
...
func GetPublicKey() *rsa.PublicKey {
	block, _ := pem.Decode([]byte(SERVER_PUB_KEY))
	enc := x509.IsEncryptedPEMBlock(block)
	b := block.Bytes
	var err error
	if enc {
